...
Integra zRouter con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de zRouter.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Cline instalada desde el marketplace de VSCode
- zRouter ejecutándose localmente o endpoint en la nube configurado
...
Establece la URL base a tu endpoint de zRouter:
...
**Para zRouter en la nube:**
```
https://zrouter.com
```

**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de zRouter
...
4. Cline usará zRouter para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando zRouter
...
3. Obtén explicaciones potenciadas por IA a través de zRouter

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará zRouter para entender el contexto y hacer cambios
...
1. Verifica que zRouter esté corriendo: `curl http://localhost:20128/health`
...
2. Verifica que tu instancia de zRouter esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de zRouter para cualquier error

## Configuración avanzada

### Usar endpoint en la nube

Para usar el endpoint en la nube de zRouter en lugar de localhost:

1. En la configuración de Cline, establece Base URL a: `https://zrouter.com`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de zRouter
...
## Integración con características de zRouter

### Enrutamiento de modelos

zRouter enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, zRouter automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de zRouter:
