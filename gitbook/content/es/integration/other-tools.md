...
zRouter es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

zRouter proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a zRouter usando estas configuraciones:

**zRouter local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de zRouter (cc/*, cx/*, glm/*, etc.)
```

**zRouter en la nube:**
```
Base URL: https://zrouter.com/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de zRouter (cc/*, cx/*, glm/*, etc.)
```
...
**Problema:** No se puede conectar a zRouter
```bash
# Verifica si zRouter está corriendo
...
**Solución:**
- Verifica que zRouter esté corriendo
...
- Verifica la conexión de red a zRouter
