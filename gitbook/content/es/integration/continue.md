...
Integra zRouter con la extensión Continue para llevar la asistencia de IA directamente a Visual Studio Code.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Continue instalada desde el marketplace de VSCode
- API key de zRouter desde el [dashboard](https://zrouter.com/dashboard)
- zRouter ejecutándose (local o en la nube)
...
### 2. Agregar configuración de modelo de zRouter
...
```json
{
  "models": [
    {
      "title": "zRouter - Claude Opus (Best)",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key-from-dashboard",
      "apiBase": "http://localhost:20128/v1"
    ...
    {
      "title": "zRouter - Claude Sonnet (Balanced)",
      "provider": "openai",
    ...
    {
      "title": "zRouter - DeepSeek Chat (Code)",
      "provider": "openai",
    ...
    {
      "title": "zRouter - Claude Haiku (Fast)",
      "provider": "openai",
...
3. Elige tu modelo preferido de zRouter
...
- Verifica que zRouter esté corriendo: `curl http://localhost:20128/health`
...
- Selecciona el modelo correcto de zRouter
...
- Verifica la latencia de red hacia zRouter
