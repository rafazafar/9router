...
Guía detallada de instalación de zRouter con consejos de solución de problemas.
...
Instala zRouter globalmente para usar desde cualquier lugar:
...
- ✅ Comando simple: `zrouter`
- ✅ Auto-actualizaciones con `npm update -g zrouter`
...
3. Se crea el directorio de datos en `~/.zrouter`
...
**Error:**
```
Error: EACCES: permission denied, mkdir '/usr/local/lib/node_modules/zrouter'
```
...
**Problema:** zRouter usa demasiada RAM
...
```bash
npm install -g pm2
pm2 start zrouter --name zrouter
pm2 save
```
...
```bash
docker pull zrouter/zrouter:latest

docker run -d \
  -p 20128:20128 \
  -e JWT_SECRET="your-secure-secret" \
  -e INITIAL_PASSWORD="your-password" \
  -v zrouter-data:/root/.zrouter \
  --name zrouter \
  zrouter/zrouter:latest
```
...
nano ~/.bashrc  # o ~/.zshrc
# Eliminar exports relacionados con zrouter
```
