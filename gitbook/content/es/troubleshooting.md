...
Problemas comunes y soluciones al usar zRouter.
...
1. **Refresh automático (por defecto):**
   zRouter refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
1. **Verifica si zRouter está ejecutándose:**
   ```bash
   # Verifica el proceso
   ps aux | grep zrouter
...
- **GitHub Issues:** [github.com/decolua/zrouter/issues](https://github.com/decolua/zrouter/issues)
