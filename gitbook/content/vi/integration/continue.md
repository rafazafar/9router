...
Tích hợp zRouter với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- zRouter API key từ [dashboard](https://zrouter.com/dashboard)
- zRouter đang chạy (cục bộ hoặc cloud)
...
- Kiểm tra zRouter đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến zRouter
