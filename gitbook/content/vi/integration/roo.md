...
Tích hợp zRouter với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model zRouter có sẵn:
...
### Connection Failed
- Xác minh zRouter đang chạy: `curl http://localhost:20128/health`
