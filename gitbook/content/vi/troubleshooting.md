...
Các vấn đề và giải pháp phổ biến khi dùng zRouter.
...
1. **Auto-refresh (mặc định):**
   zRouter tự refresh tokens. Đợi 30 giây rồi thử lại.
...
1. **Kiểm tra zRouter có chạy không:**
   ```bash
   # Check process
   ps aux | grep zrouter
