...
Những câu hỏi phổ biến về zRouter.

---

## zRouter là gì?

**zRouter là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**zRouter dùng chiến lược pricing 3 tầng:**
...
## zRouter có miễn phí không?

**Có, zRouter hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của zRouter.**
...
**zRouter theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host zRouter không?

**Có! zRouter hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.zrouter`)
...
**Có, zRouter ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.zrouter` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server zRouter
...
## Làm thế nào để cập nhật zRouter?
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/decolua/zrouter/blob/main/CHANGELOG.md)
- Backup `~/.zrouter` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/decolua/zrouter/blob/main/CONTRIBUTING.md) để biết chi tiết.

---

## Cần trợ giúp thêm?

- **Documentation:** [zrouter.com/docs](https://zrouter.com/docs)
