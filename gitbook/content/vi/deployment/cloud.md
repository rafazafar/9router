...
Triển khai zRouter trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.zrouter` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/zrouter`:
...
# If NOT using reverse proxy, allow zRouter ports
