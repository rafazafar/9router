...
Detailed installation guide for zRouter with troubleshooting tips.
...
Install zRouter globally to use from anywhere:
...
- ✅ Simple command: `zrouter`
- ✅ Auto-updates with `npm update -g zrouter`
...
3. Data directory created at `~/.zrouter`
...
**Issue:** zRouter using too much RAM
...
# Delete zrouter-related exports
```
