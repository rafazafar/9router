...
zRouter is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

zRouter provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to zRouter using these settings:

**Local zRouter:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any zRouter model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to zRouter
```bash
...
- Check network connection to zRouter
