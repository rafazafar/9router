...
Integrate zRouter with Cline VSCode extension to route your AI requests through zRouter's intelligent routing system.

## Prerequisites

- Visual Studio Code installed
- Cline extension installed from VSCode marketplace
- zRouter running locally or cloud endpoint configured
...
Set the base URL to your zRouter endpoint:
...
**Steps:**
1. In the **Base URL** field, enter your zRouter endpoint
...
3. The key should start with `sk-zrouter-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your zRouter configuration
...
4. Cline will use zRouter to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using zRouter
...
3. Get AI-powered explanations through zRouter

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use zRouter to understand context and make changes
...
1. Verify zRouter is running: `curl http://localhost:20128/health`
...
2. Verify your zRouter instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check zRouter logs for any errors

## Advanced Configuration

### Using Cloud Endpoint

To use zRouter cloud endpoint instead of localhost:

1. In Cline settings, set Base URL to: `https://zrouter.com`
2. Make sure you have configured your API key in the zRouter cloud dashboard
...
## Integration with zRouter Features

### Model Routing

zRouter automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, zRouter automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through zRouter dashboard:
- Total requests
- Token usage
- Cost per model
