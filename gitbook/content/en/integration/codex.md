...
Integrate zRouter with OpenAI Codex CLI to route your OpenAI API requests through zRouter's intelligent routing system.
...
zRouter provides the following Codex models:
...
1. Verify your API key is correct in zRouter dashboard
...
1. Verify the model name matches your zRouter configuration
2. Check that the OpenAI provider connection is active in zRouter dashboard
...
Make sure you have configured your API key in the zRouter cloud dashboard.
