...
Integrate zRouter with Claude Code CLI to route your Anthropic API requests through zRouter's intelligent routing system.
...
Claude Code supports the following model aliases that map to zRouter models:
