...
Integrate zRouter with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- zRouter API key from [dashboard](https://zrouter.com/dashboard)
- zRouter running (local or cloud)
...
### 2. Add zRouter Model Configuration
...
3. Choose your preferred zRouter model
...
- Check network latency to zRouter
