...
zRouterをClaude Code CLIと統合し、AnthropicのAPIリクエストをzRouterのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはzRouterモデルにマッピングされる以下のモデルエイリアスをサポート:
