 ...
 * API. They are zrouter fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic zrouter variant set for a single upstream Kiro model.
 *
 ...
 * into zrouter variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
