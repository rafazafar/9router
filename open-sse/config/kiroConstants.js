 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what zrouter needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a zrouter
...
/**
 * Detect whether a model id refers to a zrouter synthetic agentic variant.
...
/**
 * Detect whether a model id is a zrouter synthetic thinking variant
...
/**
 * Resolve a zrouter model id to the real upstream Kiro model id, plus flags
