...
zRouter just routes your requests to them - there's no "catch" or future billing. They're truly free services, and zRouter makes them easy to use with fallback support.
...
Use **Dashboard → Model Aliases** to map any exact client-facing model ID to a concrete zRouter route. Provider-qualified aliases are supported, for example:
