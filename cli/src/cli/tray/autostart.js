...
const APP_LABEL = "com.zrouter.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when zrouter is currently
 ...
 * SIGTERM to the running process. When the running zrouter cli.js was itself
...
<dict>
    ...
    <string>/tmp/zrouter.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/zrouter.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `zrouter.cmd` lookup that depended on the npm prefix path.
